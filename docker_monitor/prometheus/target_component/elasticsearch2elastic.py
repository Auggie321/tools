...
elasticServer = os.environ.get('ES_METRICS_CLUSTER_URL', 'http://172.40.200.10:9200')
...
elasticMonitoringCluster = os.environ.get('ES_METRICS_MONITORING_CLUSTER_URL', 'http://172.40.200.10:9200')
